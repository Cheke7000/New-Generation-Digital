// ===== Ajustes: edita aquí =====
var SHEETS_URL="https://script.google.com/macros/s/AKfycbxf4dIoZQPm6FWnUxh73C5_mUt9X9az0ldx-mOwdKcx7k7vui1HiHhIeh6VGFW6XJMS8g/exec"; // URL de tu Google Apps Script: aquí llegan los pedidos
var WA="50379741077"; // WhatsApp de la tienda (solo para cotizar): código de país + número
...
$("#checkout").onclick=function(){
  ...
  $("#cErr").textContent="";
  if(!SHEETS_URL){$("#cErr").textContent="Falta configurar el envío de pedidos.";return}
